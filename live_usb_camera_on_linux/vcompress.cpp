...
static void dumpnals(x264_t *px264, int type, x264_nal_t *nal, int nals)
{
	fprintf(stderr, "frame delframes %d max delframes %d nals %d type=%d, ======\n",
            x264_encoder_delayed_frames(px264), x264_encoder_maximum_delayed_frames(px264), nals, type);
